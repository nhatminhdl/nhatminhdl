							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Sản phẩm<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="{{URL::to('/danh-muc-san-pham/'.$item-> category_id)}}">{{$item->category_name}}</a></li>
										@endforeach
					...
					<div class="col-sm-4">
						<form action="{{URL::to('/tim-kiem')}}" method="POST">
							...
							<div>
								...
								<input type="submit" name="search_item" class="btn btn-default btn-sm" value="Tìm khiếm">
							</div>
						</form>
