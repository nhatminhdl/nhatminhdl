                ...
                <div class="panel-body">
                    <div class="position-center">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none" rows="5" class="form-control" name="product_desc" id="test" placeholder="Mô tả sản phẩm"></textarea>
                        </div>
...
<script>
    ...
    CKEDITOR.replace('exampleInputPassword1',{
        language: 'vi',
        uiColor: '#CCEAEE',
        editorplaceholder: 'Nhập nội dung sản phẩm...',
        removeButtons: 'PasteFromWord'
    });
    CKEDITOR.replace('test',{
        language: 'vi',
        uiColor: '#CCEAEE',
        editorplaceholder: 'Nhập mô tả...',
        removeButtons: 'PasteFromWord'
    });
