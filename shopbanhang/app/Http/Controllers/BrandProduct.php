...
class BrandProduct extends Controller
{
    ...
    public function save_brand_product(Request $request){
        ...
        $data['brand_startus'] = $request -> brand_product_status;
    ...
    public function active_brand_product($brand_product_id){
        $this->AuthLogin();
        DB::table('tbl_brand') -> where('brand_id',$brand_product_id) -> update(['brand_startus'=>0]);
        Session::put('message','Hủy kích hoạt thành công');
        return Redirect::to('all-brand-product');
    }
    public function unactive_brand_product($brand_product_id){
        $this->AuthLogin();
        DB::table('tbl_brand') -> where('brand_id',$brand_product_id) -> update(['brand_startus'=>1]);
